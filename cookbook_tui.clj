...
(defn- sealed-recipe?
  ...
  are is `seal/published-surface`, spelled once and asserted against the fixture
  by both suites, rather than listed inline here and in two other clients.
  ...
  (seal/published-surface-sealed? stored))
